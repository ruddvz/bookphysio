...
const footerConfig = {
  description:
    "BookPhysio empowers patients with modern tools, verified practitioners, and a seamless clinical experience to recover faster. Whether you're seeking home rehab or in-clinic visits, we provide the foundation for your physical wellbeing.",
  logo: {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-12">
          ...
          <div className="relative mb-6">
             <div className="h-10 w-[180px] flex items-center justify-start text-[24px] font-bold text-bp-primary">
                BookPhysio<span className="text-bp-accent">.in</span>
             </div>
          </div>
        ...
        <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start">
                ...
                <ul className="space-y-2">
                  {col.links.map((link, i) => (
                    <li key={i}>
                      <Link
                        href={link.href}
                        className="text-[0.85rem] text-gray-600 dark:text-gray-300 hover:text-bp-accent transition"
                      >
                        {link.label}
                      </Link>
                    </li>
          ...
          <div className="lg:w-1/4">
            {/* Contact */}
            <Card className="shadow-none border-none mb-4 bg-transparent">
              <CardContent className="p-0 space-y-3">
                <p className="text-sm font-medium">For Corporates & Universities</p>
                <form className="flex flex-col gap-3">
                  <Button variant="default" type="submit" className="w-full bg-bp-primary hover:bg-bp-accent text-white">
                    Get In Touch
                  </Button>
                </form>
              </CardContent>
            ...
            <Card className="shadow-none border-none mb-4 bg-transparent">
              <CardContent className="p-0">
                ...
                <div className="space-y-2">
                  <Link href="#" className="block text-sm text-gray-600 dark:text-gray-300 hover:text-bp-accent transition">
                    Documentation
                  </Link>
                  <Link href="#" className="block text-sm text-gray-600 dark:text-gray-300 hover:text-bp-accent transition">
                    Getting Started
                ...
                <div className="mt-4 pt-3 border-t border-gray-200 dark:border-gray-700">
                  ...
                  <div className="flex gap-3">
                    {footerConfig.socials.map(({ icon: Icon, href }, idx) => (
                      <Link key={idx} href={href} className="text-gray-500 hover:text-bp-accent transition">
        ...
        <div className="mt-12 pt-6 flex flex-col md:flex-row justify-between items-center text-xs text-gray-500 dark:text-gray-400 gap-4">
          <p>© {new Date().getFullYear()} BookPhysio.in. All rights reserved.</p>
