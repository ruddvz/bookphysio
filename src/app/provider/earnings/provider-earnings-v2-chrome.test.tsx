...
describe('ProviderEarningsV2Chrome', () => {
  ...
  it('returns null when ui-v2 is off', () => {
    ...
    const { container } = render(
      <ProviderEarningsV2Chrome monthlySettled={[1000, 1200, 1100, 1300, 1250, 1400]} totalSettledInr={7250} />
    )
    expect(container.firstChild).toBeNull()
  })

  it('renders pulse strip when ui-v2 is on', () => {
    render(<ProviderEarningsV2Chrome monthlySettled={[1000, 1200, 1100, 1300, 1250, 1400]} totalSettledInr={7250} />)
