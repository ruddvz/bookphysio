    ...
    <div className="max-w-[1240px] mx-auto px-6 md:px-10 py-10 md:py-16 animate-in fade-in duration-700">
                  ...
                  <tr key={appt.id} className="group hover:scale-[1.005] transition-all duration-300">
                    <td className="px-6 py-5 bg-[#FCFCFC] border-y border-l border-bp-border rounded-l-[32px] first:rounded-tl-[32px] first:rounded-bl-[32px]">
                       <div className="flex items-center gap-4">
                          ...
                          <div>
                             <p className="text-[17px] font-bold text-bp-primary tracking-tight leading-none mb-1.5">{appt.patient}</p>
                             <div className="flex items-center gap-2">
                                ...
                                <div className={cn("px-2.5 py-0.5 rounded-full text-[9px] font-bold uppercase tracking-[0.1em] border shadow-sm", STATUS_STLYES[appt.status])}>
                                   {appt.status}
                                </div>
                             </div>
                          </div>
                    ...
                    <td className="px-6 py-5 bg-[#FCFCFC] border-y border-bp-border">
                       <div className="flex flex-col gap-1">
                          <p className="text-[14px] font-bold text-bp-primary leading-none mb-1">{appt.disease}</p>
                    ...
                    <td className="px-6 py-5 bg-[#FCFCFC] border-y border-bp-border">
                       <div className="flex items-center gap-3 py-2 px-4 bg-white border border-bp-border rounded-2xl w-fit shadow-sm">
                          ...
                          <span className="text-[12px] font-bold text-bp-primary uppercase tracking-widest">{appt.type.replace('_', ' ')}</span>
                       </div>
                    </td>
      ...
      <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-8">
         <div className="p-8 bg-bp-surface rounded-[40px] border border-bp-border flex items-center gap-8 group cursor-pointer hover:bg-white hover:shadow-xl transition-all duration-500">
            ...
            <div>
               <p className="text-[14px] font-bold text-bp-body/40 uppercase tracking-widest mb-1">Clinic Efficiency</p>
               <h4 className="text-[24px] font-bold text-bp-primary tracking-tighter mb-2">94% Retention Rate</h4>
         ...
         <div className="p-8 bg-bp-surface rounded-[40px] border border-bp-border flex items-center gap-8 group cursor-pointer hover:bg-white hover:shadow-xl transition-all duration-500">
            ...
            <div>
               <p className="text-[14px] font-bold text-bp-body/40 uppercase tracking-widest mb-1">Practice Alert</p>
               <h4 className="text-[24px] font-bold text-bp-primary tracking-tighter mb-2">2 Pending Approvals</h4>
