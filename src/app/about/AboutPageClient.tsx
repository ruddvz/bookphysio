...
const ABOUT_TOC: StaticTocItem[] = [
  { id: 'why-we-built-this', label: 'Why we built this' },
  { id: 'four-things', label: 'Four things we care about' },
  { id: 'getting-started', label: 'We are just getting started' },
]
...
function AboutStoryBody({ withSectionIds }: { withSectionIds: boolean }) {
  return (
    <>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-12 items-center">
        <div>
          ...
          <h2
            {...(withSectionIds ? { id: 'why-we-built-this' } : {})}
      ...
      <div className="rounded-[var(--sq-lg)] border border-slate-200 bg-white p-8 lg:p-12 text-center shadow-[0_1px_3px_rgba(15,23,42,0.04)]">
        ...
        <h2
          {...(withSectionIds ? { id: 'getting-started' } : {})}
        ...
        <main className="bg-[#FAFAFA] min-h-screen">
          ...
          <section className="py-12 lg:py-16">
            <div className="max-w-[1142px] mx-auto px-6 space-y-12 lg:space-y-16">
              <AboutStoryBody withSectionIds={false} />
            </div>
          </section>
        </main>
