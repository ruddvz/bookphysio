      ...
      <div className="space-y-7">
        ...
        <div className="grid grid-cols-2 gap-3">
          <button
            ...
            className="flex items-center justify-center gap-2.5 rounded-[16px] border-2 border-bp-border/80 bg-white py-3 text-[13px] font-bold text-bp-primary transition-all hover:border-bp-border hover:shadow-md disabled:opacity-50"
          >
            {oauthLoading === 'google' ? (
