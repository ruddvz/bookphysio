...
const SPECIALTIES_DATA: Record<string, SpecialtyArticleData> = {
  ...
  'womens': {
    ...
    subtitle: 'Specialist care for every stage of a woman\'s life — from pregnancy to pelvic health.',
    description:
      "Women's health physiotherapy covers the full spectrum of pregnancy, postnatal recovery, and pelvic floor rehabilitation. Whether you are managing back pain in pregnancy, recovering from childbirth, dealing with urinary incontinence, or living with chronic pelvic pain, a specialist physiotherapist provides one-to-one, confidential care tailored to your stage of life. Sessions combine hands-on treatment with exercises you can do at home to maintain progress between appointments.",
    highlights: [
      'Safe prenatal exercise programming by trimester',
      'Pelvic floor rehabilitation and bladder retraining',
      'Postnatal core recovery and diastasis recti management',
      'Chronic pelvic pain and dyspareunia treatment',
    ],
    benefits: [
      'Reduced pregnancy-related back and pelvic pain',
      'Resolution of urinary or faecal incontinence',
      'Faster, stronger postnatal recovery',
      'Improved pelvic organ support and sexual comfort',
    ],
    conditions: [
      ...
      'Vaginismus and faecal incontinence',
    ],
  },
}
