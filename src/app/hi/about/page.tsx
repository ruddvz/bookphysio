          ...
          <div className="max-w-[1142px] mx-auto px-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-24 items-center mb-32">
              <div className="relative">
                ...
                <h2 className="text-[44px] font-black text-bp-primary mb-8 tracking-tighter leading-tight">रिहैबिलिटेशन को समझने वाला डिजिटल नेटवर्क</h2>
              ...
              <div className="aspect-square bg-bp-surface border border-bp-border/40 rounded-[48px] flex items-center justify-center p-12 text-[#9CA3AF] relative group overflow-hidden shadow-[0_32px_64px_-16px_rgba(0,0,0,0.05)]">
                ...
                <div className="text-center relative z-10 scale-110 group-hover:scale-125 transition-transform duration-1000">
                  ...
                  <p className="text-[14px] font-black text-bp-primary uppercase tracking-[0.3em]">नेशनल केयर नेटवर्क</p>
                </div>
              </div>
            </div>
            ...
            <div className="mb-32">
              <div className="text-center max-w-2xl mx-auto mb-20">
                <p className="text-[12px] font-black text-bp-accent uppercase tracking-[0.3em] mb-4">क्यों भरोसा करें</p>
                <h2 className="text-[40px] font-black text-bp-primary tracking-tighter leading-none">जिससे निर्णय आसान हो</h2>
              </div>
            ...
            <div className="text-center p-20 bg-[#111111] rounded-[64px] border border-white/5 relative overflow-hidden group">
              ...
              <div className="relative z-10">
                ...
                <h2 className="text-[48px] font-black text-white mb-6 tracking-tighter">स्पष्ट खोज, बेहतर रिकवरी</h2>
