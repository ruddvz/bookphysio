            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-20 items-start">
              <div className="lg:col-span-4 sticky top-32 group">
                <div className="space-y-16">
                  <div>
                    <h2 className="text-[12px] font-black text-bp-primary uppercase tracking-[0.4em] mb-12">एग्रीमेंट इंडेक्स</h2>
                    <ul className="space-y-6">
                      <li><a href="#acceptance" className="text-[20px] font-black text-bp-primary hover:text-bp-primary transition-all flex items-center gap-4 group/item">1.0 स्वीकृति <div className="w-1.5 h-1.5 rounded-full bg-bp-primary"></div></a></li>
                      <li><a href="#description" className="text-[20px] font-black text-bp-body/40 hover:text-bp-primary transition-all">2.0 सेवा का दायरा</a></li>
                      <li><a href="#responsibilities" className="text-[20px] font-black text-bp-body/40 hover:text-bp-primary transition-all">3.0 जिम्मेदारियाँ</a></li>
                      <li><a href="#verification" className="text-[20px] font-black text-bp-body/40 hover:text-bp-primary transition-all">4.0 प्रदाता सत्यापन</a></li>
                      <li><a href="#liability" className="text-[20px] font-black text-bp-body/40 hover:text-bp-primary transition-all">5.0 देयता</a></li>
                    </ul>
                  </div>
                  ...
                  <div className="p-10 bg-bp-surface rounded-[40px] border border-bp-border/40 relative overflow-hidden group">
                    ...
                    <h3 className="text-[24px] font-black text-bp-primary mb-5 tracking-tight">कानूनी पारदर्शिता</h3>
                ...
                <div className="prose prose-lg max-w-none text-bp-body/70 font-medium leading-[1.9] space-y-24">
                  <section id="acceptance" className="scroll-mt-32">
                    <div className="flex items-center gap-5 mb-10">
                      ...
                      <h2 className="text-[36px] font-black text-bp-primary tracking-tighter leading-none m-0">1.0 शर्तों की स्वीकृति</h2>
                    </div>
                  ...
                  <section id="description" className="scroll-mt-32">
                    <div className="flex items-center gap-5 mb-10">
                      ...
                      <h2 className="text-[36px] font-black text-bp-primary tracking-tighter leading-none m-0">2.0 सेवा का विवरण</h2>
                    </div>
                    <div className="p-10 bg-[#111111] rounded-[40px] text-white overflow-hidden relative group mb-10">
                      ...
                      <p className="text-[19px] font-medium leading-relaxed opacity-80 relative z-10">
                        BookPhysio मरीजों को फिजियोथेरेपिस्ट्स से जोड़ने वाला डिजिटल प्लेटफॉर्म है। <span className="text-white font-black italic">हम स्वयं चिकित्सा सलाह या उपचार प्रदान नहीं करते।</span>
                      </p>
                    </div>
                  ...
                  <section id="responsibilities" className="scroll-mt-32">
                    <div className="flex items-center gap-5 mb-10">
                      ...
                      <h2 className="text-[36px] font-black text-bp-primary tracking-tighter leading-none m-0">3.0 उपयोगकर्ता जिम्मेदारियाँ</h2>
                    </div>
                  ...
                  <section id="verification" className="scroll-mt-32">
                    <div className="flex items-center gap-5 mb-10">
                      ...
                      <h2 className="text-[36px] font-black text-bp-primary tracking-tighter leading-none m-0">4.0 प्रदाता सत्यापन</h2>
                    </div>
                  ...
                  <section id="liability" className="scroll-mt-32">
                    <div className="flex items-center gap-5 mb-10">
                      ...
                      <h2 className="text-[36px] font-black text-bp-primary tracking-tighter leading-none m-0">5.0 देयता की सीमा</h2>
                    </div>
                    <p className="text-[18px] leading-relaxed">
                  ...
                  <section className="bg-bp-surface px-12 py-12 rounded-[48px] mt-16 border border-bp-border/40 group overflow-hidden relative">
                    ...
                    <div className="flex flex-col md:flex-row gap-10 items-center text-center md:text-left relative z-10">
                      ...
                      <div>
                        <h3 className="text-[24px] font-black text-bp-primary mb-2">परिवर्तनों की सूचना</h3>
