-- Fix search_providers_v2 so provider search works in production.
-- The prior definition referenced an out-of-scope alias in the outer SELECT
-- and used GREATER instead of GREATEST inside the Haversine clamp.
